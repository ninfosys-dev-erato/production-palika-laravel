...
use SrcPermissionsModelsPermission;
    ...
    public function run() void
    {
        $permissions = [
            ...
            ['name' = 'group_update', 'guard' = 'web'],
             ['name' = 'letter_head_manage', 'guard' = 'web'],  Not used in AdminSettings module code
             ['name' = 'letter_head_update', 'guard' = 'web'],  Not used in AdminSettings module code
             ['name' = 'letter_head_delete', 'guard' = 'web'],  Not used in AdminSettings module code
             ['name' = 'setting_groups create', 'guard' = 'web'],  Not used in AdminSettings module code
             ['name' = 'setting_groups edit', 'guard' = 'web'],  Not used in AdminSettings module code
             ['name' = 'setting_groups delete', 'guard' = 'web'],  Not used in AdminSettings module code
            ...
            ['name' = 'emergency_contact edit', 'guard' = 'web'],
