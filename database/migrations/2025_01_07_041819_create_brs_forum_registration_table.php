...
return new class extends Migration
{
    ...
    {
        Schema::create('brs_forum_registration', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('forum_establish_date')->nullable();
    ...
    {
        Schema::dropIfExists('brs_forum_registration');
    }
};
