...
namespace Domains\AdminGateway\Grievance\Resources;
...
use Src\Customers\Resources\CustomerResouce;
...
class AdminGrievanceDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            'id' => $this->id,
            'token' => $this->token,
            'grievance_detail_id' => $this->whenLoaded('grievanceDetail') ? new AdminGrievanceDetailResource($this->grievanceDetail) : null,
            ...
            'customer' => $this->whenLoaded('customer') ? CustomerResouce::make($this->customer) : null,
