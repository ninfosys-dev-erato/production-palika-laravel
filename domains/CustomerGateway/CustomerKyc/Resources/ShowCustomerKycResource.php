...
class ShowCustomerKycResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'document_image1' => ImageServiceFacade::getImage($documentPath, $this->document_image1, 'local'),
            'document_image2' => ImageServiceFacade::getImage($documentPath, $this->document_image2, 'local'),
