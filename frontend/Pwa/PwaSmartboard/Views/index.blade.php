        ...
        <header style="height: 12vh; background: var(--primary); color: var(--text-primary);">
            <div class="d-flex justify-content-between align-items-center container-fluid"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="text-white font-monospace" style="font-size: 0.6rem" id="current-time">Loading....</div>
                </div>

                <p class="m-0 text-center ms-1" style="font-size: 0.6rem;">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between " style="height: 9vh">
                ...
                <div class="text-center ms-5">
                    ...
                    <h4 class="fw-bold mb-1" style="font-size: 0.7rem;">
    ...
    getSetting('palika-province') . ', ' . getSetting('palika-district') . ', नेपाल' }}
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-1 " style="font-size: 0.6rem; color: rgba(255, 255, 255, 0.822);">
                        ...
                        <p class="m-0">समृद्ध {{ getSetting('palika-name') }}, सभ्य समाज</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main style="height: 80vh">
            <div class="d-flex container-fluid" style="height: 100%">
                <div class="d-flex h-100 pt-3" style="width: 75%;">
                    <livewire:pwa.pwa_smartboard.pwa_tv :ward="$ward" />
                </div>
                {{-- citizen-charter section --}}
                <div class="h-100 px-2 py-3 ms-3" style="width: 25%">
                    <h2 class="fw-bold" style="font-size: 1rem">नागरिक वडापत्र</h2>
        ...
        <footer style="height: 3vh; background: var(--primary); color: var(--text-primary);">
            <div class="text-center text-light py-2">
                <p class="mb-0" style="font-size: 0.7rem;">{{ date('Y') }} © Design and Developed by Ninja Infosys</p>
            </div>
        </footer>
