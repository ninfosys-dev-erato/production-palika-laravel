...
<body>
        ...
        <header style="height: 12vh; background: var(--primary); color: var(--text-primary);">
            <div class="d-flex justify-content-between align-items-center container-fluid"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="text-white ms-1 font-monospace" style="font-size: 0.6rem" id="current-time">Loading....
                    </div>
                </div>
        ...
        <main style="height: 80vh">
            <div class="d-flex container-fluid" style="height: 100%">
                <div class="h-100" style="width: 75%;">
                    <livewire:pwa.pwa_smartboard.employees :ward="$ward" />
                </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const redirectTimeout = 300000; // 5 minute
            setTimeout(() => {
