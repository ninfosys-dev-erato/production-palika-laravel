...
<body>
    <div>
        ...
        <header style="height: 12vh; background: var(--primary); color: var(--text-primary);">
            <div class="d-flex justify-content-between align-items-center container-fluid"
                ...
                <div class="d-flex gap-1 align-items-center">
                    ...
                    <div class="text-white" style="font-size: 0.6rem" id="current-date">Loading...</div>
                </div>
            </div>
        ...
        <main style="height: 80vh">
            <div class="d-flex container-fluid gap-3" style="height: 100%">
                <div class="h-100" style="width: 75%;">
                    <livewire:pwa.pwa_smartboard.videos :ward="$ward" />
                </div>
                {{-- citizen-charter section --}}
                <div class="h-100 px-2 py-3" style="width: 25%">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const redirectTimeout = 600000; // 10 minutes
            setTimeout(() => {
