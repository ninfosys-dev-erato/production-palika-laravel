<section class="notice-component-wrapper py-5">
                        ...
                        <div class="collapse date-picker-dropdown" id="toggleStartDate">
                            <div class="input-group">
                                <input type="text" class="form-control nepali-date" id="start_date"
                                    wire:model="start_date" value="{{ request('start_date') }}" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="collapse date-picker-dropdown" id="toggleEndDate">
                            <div class="input-group">
                                <input type="text" class="form-control nepali-date" id="end_date"
                                    wire:model="end_date" value="{{ request('end_date') }}" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="notices-section">
        <div class="section-header mb-4">
            <div class="section-title" style="text-color: #01399a;">
                <div class="icon-wrapper" style="color: #01399a;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        style="text-color: #01399a;" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                        <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
                    </svg>
                </div>
                <span class="fs-4 fw-500" style="color: #01399a;">सूचना</span>
            </div>
        </div>

        <!-- Notice Carousel - Preserving original structure -->
                                        ...
                                        <div class="app-card h-100">
                                            <div class="card-img-container">
                                                <img src="{{ asset('storage/digital-board/notices/' . $notice->file) }}"
                                                    class="card-img-top" alt="{{ $notice->title }}">
                                            </div>
                                            <div class="card-body">
                                                <h5 class="card-title">{{ $notice->title }}</h5>
                                                @if (isset($notice->date))
                                                    <p class="card-text small text-muted">
                                                        प्रकाशित मिति: {{ $notice->date }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            @else
                                <div class="w-100 text-center py-5">
                                    <div class="alert alert-info d-inline-block">
                                        <p class="mb-0">कुनै सूचना उपलब्ध छैन</p>
                                    </div>
                                </div>
                            @endif
                        </div>
