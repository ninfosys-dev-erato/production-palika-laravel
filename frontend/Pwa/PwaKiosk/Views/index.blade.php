...
<div>
    ...
    <main>
        <!-- notices section -->
        <livewire:pwa.pwa_kiosk.pwa_kiosk :$ward/>
        <!-- Content Section -->
    </main>

    <footer style="height: 3vh; background: var(--primary); color: var(--text-primary);">
        <div class="bg-primary text-center text-light py-2">
            <p class="mb-0" style="font-size: 0.7rem;">2024 - 2025 © Design and Developed by Ninja Infosys</p>
        </div>
    </footer>
</div>
