<div class="flex flex-col sm:max-w-[800px] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1400px] sm:mx-auto mx-2 lg:flex-row gap-4 sm:gap-8 font-inter xl:my-16 md:justify-between">
    <div class="flex-row lg:flex-col gap-2 md:w-2/6 py-1 md:py-3 justify-center lg:justify-start items-center lg:items-start xl:py-16 w-full md:w-auto  lg:flex mx-2 md:mx-auto">
        <div class="relative mb-1">
            ...
            @if ($isDropdownVisible)
                <div class="absolute top-10 left-0 bg-white shadow-md rounded-md w-full z-10 max-h-64 overflow-y-auto">
                    <ul>
                        <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer" wire:click="showAllPrograms">
                            {{ __('All Wards') }}
                        </li>
    ...
    <div class="w-full mx-auto md:w-4/6">
        <div class="flex flex-col">
            ...
            <div class="md:w-full flex flex-col md:flex-row mx-3 md:mx-0 md:justify-between gap-2 md:gap-6">
                ...
                <button wire:click="searchPrograms"
            ...
            <div class="md:mt-12 xl:ml-16 mt-6 mx-3 sm:mx-0 grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-6">
        ...
        <div class="flex items-center justify-between mt-4 mx-4">
            ...
            <nav class="flex items-center space-x-2">
                ...
                @foreach ($programs->links()->elements[0] as $page => $url)
