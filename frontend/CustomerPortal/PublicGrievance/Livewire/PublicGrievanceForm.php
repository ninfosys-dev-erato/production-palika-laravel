...
namespace Frontend\CustomerPortal\PublicGrievance\Livewire;
...
class PublicGrievanceForm extends Component
{
    use SessionFlash;
    use WithFileUploads;
    ...
    {
        return view("CustomerPortal.PublicGrievance::livewire.grievance-form");
    }
    ...
    public function save()
    {
        ...
        try{
            ...
            return redirect()->route('customer.home.grievance-list');
        }catch (\Throwable $e){
            logger($e->getMessage());
