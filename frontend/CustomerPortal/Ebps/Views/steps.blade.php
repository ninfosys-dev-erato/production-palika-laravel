<x-layout.customer-app header="{{ __('Map Apply Steps') }}">
            ...
            <div class="card-header bg-white border-bottom py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('organization.ebps.map_apply.index') }}" class="btn btn-outline-primary">
            ...
            <div class="card-body p-4">
                <div class="position-relative mb-5 px-4">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <h6 class="fw-semibold">{{ __('Overall Progress') }}</h6>
                    ...
                    <div class="timeline-steps mb-4">
                        @foreach ($mapStepsBefore as $index => $mapStep)
                            @php
                                ...
                                $status = $appliedStep ? $appliedStep->status : 'Not Applied';
                                        ...
                                        <div class="card shadow-sm border-0 ms-3 h-100">
                                            <div class="card-body p-3">
                                                ...
                                                <div class="d-flex justify-content-end mt-2">
                                                    ...
                                                    @if ($mapApplyStep)
                                                        <a href="{{ route('customer.ebps.apply.preview-map-step', ['mapApplyStep' => $mapApplyStep]) }}"
