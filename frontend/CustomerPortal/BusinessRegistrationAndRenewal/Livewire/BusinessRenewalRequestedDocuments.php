...
class BusinessRenewalRequestedDocuments extends Component{
    ...
    {
        return view('CustomerPortal.BusinessRegistrationAndRenewal::livewire.renewal.documents');
    }
    ...
    public function addDocument(): void
    {
        ...
        $this->successToast(__("Document added successfully"));
    }

    public function removeDocument(int $index): void{
        unset($this->documents[$index]);
        $this->successToast(__("Document successfully removed"));
    }
    ...
    public function save(int $index)
    {
        ...
        if($result){
            $this->successToast(__("Document saved successfully"));
        }else{
            $this->errorToast(__("Document saving failed"));
        }
    }
