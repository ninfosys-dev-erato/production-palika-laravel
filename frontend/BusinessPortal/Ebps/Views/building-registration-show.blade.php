        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body border-start border-dark border-3 bg-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="h4 mb-1 fw-bold text-primary">{{ __('ebps::ebps.building_registration_details') }}
                        </h2>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="border p-3 h-100 bg-light">
                                ...
                                <span class="text-dark">{{ $mapApply->landOwner->owner_name ?? 'Not Provided' }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border p-3 h-100 bg-light">
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <div class="border p-3 h-100 bg-light">
                                <strong class="d-block mb-1 text-dark">३.१ नाम:</strong>
                                <span class="text-dark">{{ $mapApply->houseOwner->owner_name ?? 'Not Provided' }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border p-3 h-100 bg-light">
                                <strong class="d-block mb-1 text-dark">३.२ फोन नं:</strong>
                                <span class="text-dark">{{ $mapApply->houseOwner->mobile_no ?? 'Not Provided' }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border p-3 h-100 bg-light">
