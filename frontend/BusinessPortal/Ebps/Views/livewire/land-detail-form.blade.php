<form wire:submit.prevent="save">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                <select id="local_body_id" wire:change="loadWards" name="customerLandDetail.local_body_id"
                    class="form-control" wire:model="customerLandDetail.local_body_id">
            ...
            <div class='col-md-6 mb-4'>
                <div class='form-group'>
                    <label for='is_landlord'>{{ __('Is Landlord') }}</label>
        ...
        <div class=" d-flex justify-content-between mb-4">
            <label class="form-label" for="form-label">{{ __('Four Boundaries') }}</label>
    ...
    <div class="card-footer">
        ...
        <a href="{{ route('admin.customer_land_detais.index') }}" wire:loading.attr="disabled"
