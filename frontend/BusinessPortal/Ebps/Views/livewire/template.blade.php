<div>
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="bg-white p-3 rounded shadow-sm sticky-top" style="z-index: 1030;">
                    <!-- Header Section -->
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-3">
                        <h5 class="mb-2 mb-md-0 text-dark fw-bold">Form Navigation</h5>

                        <!-- Center Buttons -->
                        <div class="d-flex flex-wrap justify-content-center align-items-center gap-2 my-2">
                            @if ($this->activeFormId === 'custom')
                                <button class="btn btn-outline-primary" type="button" wire:loading.attr="disabled"
                                    wire:click="save" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    title="Save the current form data">
                                    <i class="bx bx-save"></i>
                                    {{ __('ebps::ebps.save') }}
                                </button>
                            @else
                                <button class="btn btn-outline-primary" type="button" wire:loading.attr="disabled"
                                    wire:click="writeAdditionalFormTemplate" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Save the current template">
                                    <i class="bx bx-save"></i>
                                    {{ __('ebps::ebps.save') }}
                                </button>
                                <button class="btn btn-outline-primary" type="button" wire:loading.attr="disabled"
                                    wire:click="resetLetter" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    title="Reset the form to its original state">
                                    <i class="bx bx-reset"></i>
                                    {{ __('ebps::ebps.reset') }}
                                </button>
                                <!-- Toggle Preview/Edit Mode -->
                                <div class="d-flex align-items-center gap-2">
                                    <label class="form-label mb-0" for="previewToggle" style="font-size: 0.9rem;"
                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="{{ $preview ? 'Switch to edit mode' : 'Switch to preview mode' }}">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input type="checkbox" id="previewToggle" class="form-check-input"
                                            ...
                                            wire:click="togglePreview" data-bs-toggle="tooltip"
                        ...
                        <!-- Back Button -->
                        <a href="javascript:history.back()" class="btn btn-outline-primary" data-bs-toggle="tooltip"
                            data-bs-placement="bottom" title="Go back to the previous page">
                            <i class="bx bx-arrow-back"></i> {{ __('Back') }}
                        </a>
                    </div>
                    <hr>
                    <!-- Navigation Tabs -->
                    <ul class="nav nav-pills nav-fill flex-wrap gap-2">
                        <li class="nav-item">
                            <button type="button" class="nav-link {{ $activeFormId === 'custom' ? 'active' : '' }}"
                                wire:click="switchToForm('custom')" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                title="{{ __('ebps::ebps.additional_form') }}">
                                <i class="bx bx-file me-1"></i>
                                {{ __('ebps::ebps.additional_form') }}
                            </button>
                        </li>
                        @foreach ($additionalFormsTemplate as $formTemplate)
                            <li class="nav-item">
                                <button type="button"
                                    class="nav-link d-flex justify-content-between align-items-center {{ $activeFormId === $formTemplate['id'] ? 'active' : '' }}"
                                    wire:click="switchToForm({{ $formTemplate['id'] }})"
                                    style="min-width: 180px; max-width: 240px;" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="{{ $formTemplate['name'] }}">
                                    ...
                                    <span
                                        ...
                                        style="font-size: 0.75rem; padding: 0.35em 0.6em; border-radius: 10px;"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            ...
                                            wire:model="mapApplyDetail.construction_purpose_id">
                                            <option value="">छानुहोस *</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="land_use_area_changes"
                                            wire:model="mapApplyDetail.land_use_area_changes"
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">13. साविक अन्य निर्माण (भवन वाहेक जस्तै प्रस्वाल,
                                            ...
                                            काटिसकेको</label>
                                        <input type="text"
                                            wire:model="mapApplyDetail.former_other_construction_area"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            class="form-select @error('building_roof_type_id') is-invalid @enderror"
                                            name="building_roof_type_id"
                                            wire:model="mapApplyDetail.building_roof_type_id" required>
                                            <option value="">छानुहोस *</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <input type="text"
                                            ...
                                            wire:model="mapApplyDetail.public_property_name"
