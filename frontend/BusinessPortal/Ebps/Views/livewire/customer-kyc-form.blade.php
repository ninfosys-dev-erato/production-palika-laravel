            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="customer.nepali_date_of_birth" id="nepali_date_of_birth"
                        class="form-control nepali-date {{ $errors->has('customer.nepali_date_of_birth') ? 'is-invalid' : '' }}"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <label class="form-label" for="ward_id">{{ __('Ward') }}</label>
                        <select id="ward_id" name="customer.permanent_ward_id"
                            class="form-control {{ $errors->has('customer.permanent_ward_id') ? 'is-invalid' : '' }}"
                            style="{{ $errors->has('customer.permanent_ward_id') ? 'border: 1px solid #dc3545; box-shadow: 0 0 0 0.2rem rgba(220, 53, 69, 0.25);' : '' }}"
                            wire:model="customer.permanent_ward_id">
                            <option value="">{{ __('Choose Ward') }}</option>
                            @foreach ($permanentWards as $id => $title)
                                <option value="{{ $id }}"
                                    {{ old('customer.permanent_ward_id', $customer->permanent_ward_id) == $id ? 'selected' : '' }}>
                                    {{ $title }}</option>
                            @endforeach
                        </select>
                        @error('customer.permanent_ward_id')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <select id="province_id" name="customer.temporary_province_id"
                                ...
                                wire:model="customer.temporary_province_id" wire:change="permanentLoadDistricts">
                                <option value="">{{ __('Choose Province') }}</option>
                                @foreach ($provinces as $id => $title)
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select id="district_id" name="customer.temporary_district_id"
                                ...
                                wire:model="customer.temporary_district_id" wire:change="temporaryLoadLocalBodies">
                                <option value="">{{ __('Choose District') }}</option>
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="form-label" for="ward_id">{{ __('Ward') }}</label>
                            <select id="ward_id" name="customer.temporary_ward_id"
                                class="form-control {{ $errors->has('customer.temporary_ward_id') ? 'is-invalid' : '' }}"
                                style="{{ $errors->has('customer.temporary_ward_id') ? 'border: 1px solid #dc3545; box-shadow: 0 0 0 0.2rem rgba(220, 53, 69, 0.25);' : '' }}"
                                wire:model="customer.temporary_ward_id">
                                <option value="">{{ __('Choose Ward') }}</option>
                                @foreach ($temporaryWards as $id => $title)
                                    <option value="{{ $id }}">{{ $title }}</option>
                                @endforeach
                            </select>
                            @error('customer.temporary_ward_id')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-4">
                ...
                <div class="row">
                    ...
                    @if ($showDocumentBackInput)
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                @enderror
                                @if ($uploadedImage2)
                                    <img src="{{ $uploadedImage2->temporaryUrl() }}" alt="Uploaded Image Preview"
                                        class="img-thumbnail mt-2" style="height: 300px;">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="customer.document_issued_date_nepali"
                            class="form-control nepali-date {{ $errors->has('customer.document_issued_date_nepali') ? 'is-invalid' : '' }}"
