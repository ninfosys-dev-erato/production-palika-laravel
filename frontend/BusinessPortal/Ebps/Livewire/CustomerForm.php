...
class CustomerForm extends Component
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'customer.permanent_ward_id' => ['required', 'integer'],
            ...
            'customer.temporary_ward_id' => ['nullable', 'integer'],
            ...
            'uploadedImage1' => ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:10240'],
            'customer.expiry_date_english' => ['nullable', 'date'],
        ];

        if ($this->showDocumentBackInput) {
            $rules['uploadedImage2'] = ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:10240'];
        } else {
            $rules['uploadedImage2'] = ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:10240'];
        }
    ...
    public function messages(): array
    {
        return [
            ...
            'customer.permanent_ward_id.integer' => __('The permanent ward must be an integer.'),
            'customer.permanent_ward_id.required' => __('The permanent ward is required.'),
            ...
            'customer.temporary_ward_id.integer' => __('The temporary ward must be an integer.'),
    ...
    public function render()
    {
        ...
        return view("BusinessPortal.Ebps::livewire.customer-kyc-form", ['genderOptions' => $genderOptions, 'documentOptions' => $documentOptions, 'provinces' => $this->provinces]);
    }
    ...
    public function mount(Customer $customer, Action $action)
    {   
    ...
    public function save()
    {
        ...
        try{
            ...
            switch ($this->action) {
                case Action::CREATE:
                    $customer = $service->store($dto);
                    $this->successFlash(__("Customer Created Successfully"));
                    return redirect()->route('organization.ebps.map_apply.create', ['customerId' => $customer->id]);
            }
        }catch (\Throwable $e){
            logger($e->getMessage());
    ...
    {
        $this->customer->document_image1 = $this->handleFileUpload($this->uploadedImage1);
