<x-layout.app header="{{ __('ejalas::ejalas.settlement_list') }}">
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header  d-flex justify-content-between">
                    ...
                    <div>
                        @perm('settlements create')
                            <a href="{{ route('admin.ejalas.settlements.create', ['from' => 'reconciliationcenter']) }}"
                ...
                <div class="card-body">
                    <livewire:ejalas.settlement_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
