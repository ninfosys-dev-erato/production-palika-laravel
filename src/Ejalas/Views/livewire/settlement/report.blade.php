<div>
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex w-100 align-items-center">
                        <div class="me-3">
                            <label for="startDate" class="form-label">{{ __('ejalas::ejalas.settled_status') }}</label>
                            <select name="" id="" wire:model="settledStatus" class="form-select">
                                <option value="1" selected>{{ __('ejalas::ejalas.settled') }}</option>
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <livewire:ejalas.settlement_table theme="bootstrap-4" :report="true" />
                </div>
            </div>
        </div>
    </div>
