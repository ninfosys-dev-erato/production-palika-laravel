    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 30px;">म्याद मिति</th>
                <th style="width: 30px;">तामेलीको म्याद</th>
                <th style="width: 30px;">दर्ता अधिकारी</th>
        ...
        <tbody>
            @foreach ($reports as $report)
                <tr class="hover:bg-gray-50">
                    ...
                    <td>{{ $report->deadline_set_date_bs }}</td>
                    <td>{{ $report->deadline_extension_period }}</td>
                    <td>{{ $report->judicialMember?->title }}</td>
