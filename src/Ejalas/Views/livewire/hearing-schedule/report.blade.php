<div>
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex w-100 align-items-center">
                        <!-- Reconciliation Center Dropdown -->
                        <div class="me-3">
                            <label for="reconciliation" class="form-label"> {{ __('ejalas::ejalas.reconciliation_center') }}</label>
                            <select id="reconciliation" name="reconciliation" wire:model="selectedReconciliationCenter"
                        ...
                        <div class="me-3">
                            ...
                            <input type="text" class="form-control" id="startDate" wire:model="startDate" required />
                            <div>
                                @error('startDate')
                        ...
                        <div class="me-3">
                            ...
                            <input type="text" class="form-control" id="endDate" wire:model="endDate" required />
                            <div>
                                @error('endDate')
                                    <small class='text-danger'>{{ __($message) }}</small>
                                @enderror
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <livewire:ejalas.hearing_schedule_table theme="bootstrap-4" :report="true" />
                </div>
            </div>
        </div>
    </div>
