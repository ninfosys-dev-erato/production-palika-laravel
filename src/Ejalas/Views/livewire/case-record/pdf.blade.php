    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 30px;">छलफल मिति</th>
                <th style="width: 100px;">निर्णय मिति</th>
                <th style="width: 100px;">निर्णय गर्ने अधिकारी</th>
                <th style="width: 50px;">अभिलेख गर्ने अधिकारी</th>
                <th style="width: 30px;">पद</th>
        ...
        <tbody>
            @foreach ($reports as $report)
                <tr class="hover:bg-gray-50">
                    ...
                    <td>{{ $report->discussion_date }}</td>
                    <td>{{ $report->decision_date_bs }}</td>
                    <td>{{ $report->judicialMember->title }}</td>
                    <td>{{ $report->judicialEmployee->name }}</td>
                    <td>{{ $report->recording_officer_position }}</td>
