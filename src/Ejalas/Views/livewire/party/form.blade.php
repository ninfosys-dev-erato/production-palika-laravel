<form wire:submit.prevent="save" class="mx-4">
    ...
    <div class="mb-4">
        <label for="phone" class="form-label fw-bold fs-7 d-block">{{ __('ejalas::ejalas.search_user_by_phone_number') }}</label>
        <div class="input-group">
            <input type="text" class="form-control" id="phone" wire:model.defer="phone" placeholder={{ __('ejalas::ejalas.enter_phone_number') }} aria-label="Phone number" aria-describedby="button-addon2">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <label for="name">{{ __('ejalas::ejalas.name') }}</label>
            </div>
            @error('party.name')
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <label for="gender">{{ __('ejalas::ejalas.gender') }}</label>
            </div>
            @error('party.gender')
                <small class='text-danger'>{{ __($message) }}</small>
            @enderror
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <input wire:model="party.age" id="age" name="age" type="number" class="form-control"
                    placeholder="{{ __('ejalas::ejalas.enter_age') }}">
                <label for="age">{{ __('ejalas::ejalas.age') }}</label>
            </div>
            @error('party.age')
                <small class='text-danger'>{{ __($message) }}</small>
            @enderror
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="phone_no">{{ __('ejalas::ejalas.phone_no') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="citizenship_no">{{ __('ejalas::ejalas.citizenship_no') }}</label>
            </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="grandfather_name">{{ __('ejalas::ejalas.grandfather_name') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="father_name">{{ __('ejalas::ejalas.father_name') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="spouse_name">{{ __('ejalas::ejalas.spouse_name') }}</label>
            </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <select wire:model="party.permanent_province_id" id="permanent_province_id" name="permanent_province_id"
                    type="text" class="form-select" wire:change='getDistrict'>
                    <option value="" hidden>{{ __('ejalas::ejalas.select_a_province') }}</option>
                    @foreach ($provinces as $key => $value)
                        <option value="{{ $key }}">{{ $value }}</option>
                    @endforeach
                </select>
                <label for="permanent_province_id">{{ __('ejalas::ejalas.permanent_province') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <select wire:model="party.permanent_district_id" id="permanent_district_id" name="permanent_district_id"
                    type="text" class="form-select" wire:change='getLocalBody'
                ...
                <label for="permanent_district_id">{{ __('ejalas::ejalas.permanent_district') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                {{-- <input wire:model="party.permanent_local_body_id" id="permanent_local_body_id"
                    name="permanent_local_body_id" type="text" class="form-control"
                    placeholder="{{ __('ejalas::ejalas.enter_permanent_local_body_id') }}"> --}}
                <select wire:model="party.permanent_local_body_id" id="permanent_local_body_id"
                    name="permanent_local_body_id" type="text" class="form-select" wire:change='getWard'
                ...
                <label for="permanent_local_body_id">{{ __('ejalas::ejalas.permanent_local_body') }}</label>
            </div>
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                {{-- <input wire:model="party.permanent_ward_id" id="permanent_ward_id" name="permanent_ward_id"
                    type="text" class="form-control" placeholder="{{ __('ejalas::ejalas.enter_permanent_ward_no') }}"> --}}
                <select wire:model="party.permanent_ward_id" id="permanent_ward_id" name="permanent_ward_id" type="text"
                    class="form-select">
                ...
                <label for="permanent_ward_id">{{ __('ejalas::ejalas.permanent_ward_no') }}</label>
            </div>
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <label for="permanent_tole">{{ __('ejalas::ejalas.permanent_tolestreet') }}</label>
            </div>
    ...
    {{-- <div class="form-check mb-3 d-flex justify-content-end">
        <input class="form-check-input mt-1 mr-1" type="checkbox" id="sameAsPermanent">
        <label class="form-check-label" for="sameAsPermanent">{{ __('ejalas::ejalas.same_as_permanent_address') }}</label>
    </div> --}}
    <div class="row">
        <!-- Temporary Province -->
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <select wire:model="party.temporary_province_id" id="temporary_province_id" name="temporary_province_id"
                    class="form-select" wire:change="getTemporaryDistrict">
                    <option value="" hidden>{{ __('ejalas::ejalas.select_a_province') }}</option>
                    @foreach ($provinces as $key => $value)
                        <option value="{{ $key }}">{{ $value }}</option>
                    @endforeach
                </select>
                <label for="temporary_province_id">{{ __('ejalas::ejalas.temporary_province') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <select wire:model="party.temporary_district_id" id="temporary_district_id" name="temporary_district_id"
                    class="form-select" wire:change="getTemporaryLocalBody">
                    <option value="" hidden>{{ __('ejalas::ejalas.select_a_district') }}</option>
                    @foreach ($temporaryDistricts as $key => $value)
                        <option value="{{ $key }}">{{ $value }}</option>
                    @endforeach
                </select>
                <label for="temporary_district_id">{{ __('ejalas::ejalas.temporary_district') }}</label>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                ...
                <label for="temporary_local_body_id">{{ __('ejalas::ejalas.temporary_local_body') }}</label>
            </div>
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <label for="temporary_ward_id">{{ __('ejalas::ejalas.temporary_ward_no') }}</label>
            </div>
        ...
        <!-- Temporary Tole/Street (remains a text input) -->
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <label for="temporary_tole">{{ __('ejalas::ejalas.temporary_tolestreet') }}</label>
            </div>
    ...
    <div class="card-footer">
        ...
        {{-- <a href="{{ route('admin.ejalas.parties.index') }}" class="btn btn-danger" wire:loading.attr="disabled">
