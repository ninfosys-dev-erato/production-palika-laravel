...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th style="width: 30px;">मुद्दा नं</th>
                <th style="width: 30px;">पूरा गर्ने पक्ष</th>
                <th style="width: 100px;">पूरा गरिएको व्यहोरा</th>
                <th style="width: 100px;">पूरा गरिएको शर्त</th>
                <th style="width: 100px;">शर्त पुरा गरेको प्रमाण</th>
                <th style="width: 30px;">शर्त पुरा गर्नु पर्ने मिति</th>
                <th style="width: 30px;">शर्त पुरा गरेको मिति</th>
                <th style="width: 80px;">प्रविष्टी गर्ने अधिकारी</th>
                <th style="width: 30px;">प्रविष्टि मिति</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($reports as $report)
                <tr class="hover:bg-gray-50">
                    ...
                    <td>{{ $report->completion_details }}</td>
                    <td>{{ $report->SettlementDetail->detail }}</td>
                    <td>{{ $report->completion_proof }}</td>
                    <td>{{ $report->due_date }}</td>
                    <td>{{ $report->completion_date }}</td>
                    <td>{{ $report->judicialEmployee?->name }}</td>
                    <td>{{ $report->entry_date_bs }}</td>
