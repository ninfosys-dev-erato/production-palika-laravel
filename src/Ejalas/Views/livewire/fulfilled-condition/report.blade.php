            ...
            <div class="d-flex justify-content-between align-items-center mx-4 mb-0">
                <div class="divider divider-primary text-start text-primary fw-bold flex-grow-1 mb-0">
                    <div class="divider-text fs-5">
                        {{ __('ejalas::ejalas.fulfilled_condition_report') }}
                    </div>
                </div>
                    ...
                    <table class="bordered-table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('ejalas::ejalas.condition') }}</th>
                                <th>{{ __('ejalas::ejalas.condition_completion_date') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($fulfilledConditions as $condition)
                                <tr>
                                    ...
                                    <td>{{ $condition->party?->name ?? '' }}</td>
                                    <td>{{ $condition->SettlementDetail?->detail ?? '' }}</td>
                                    <td>{{ $condition->completion_date ?? '' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
