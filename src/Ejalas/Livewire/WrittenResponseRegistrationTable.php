...
class WrittenResponseRegistrationTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        ...
        if (can('written_response_registrations edit') || can('written_response_registrations delete')) {
            $actionsColumn = Column::make(__('ejalas::ejalas.actions'))->label(function ($row, Column $column) {
                $buttons = '';

                if (can('written_response_registrations edit')) {
                    $edit = '<button class="btn btn-primary btn-sm" wire:click="edit(' . $row->id . ')" ><i class="bx bx-edit"></i></button>&nbsp;';
                    $buttons .= $edit;
                }

                if (can('written_response_registrations delete')) {
                ...
                if (can('written_response_registrations print')) {
