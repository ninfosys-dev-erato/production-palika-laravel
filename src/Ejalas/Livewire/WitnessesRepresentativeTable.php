...
class WitnessesRepresentativeTable extends DataTableComponent
{
    ...
    public function edit($id)
    {
     ...
     $this->dispatch('edit-witnessRepresentativeForm', witnessesRepresentative: $id);
    ...
    public function delete($id)
    {
        ...
        $this->successToast(__('ejalas::ejalas.witnesses_representative_deleted_successfully'));
    }
