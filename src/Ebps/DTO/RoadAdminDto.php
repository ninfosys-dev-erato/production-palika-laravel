...
class RoadAdminDto
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            $data['direction'] ?? null,
            $data['width'] ?? null,
            $data['dist_from_middle'] ?? null,
            $data['min_dist_from_middle'] ?? null,
            $data['dist_from_side'] ?? null,
            $data['min_dist_from_side'] ?? null,
            $data['dist_from_right'] ?? null,
            $data['min_dist_from_right'] ?? null,
            $data['setback'] ?? null,
            $data['min_setback'] ?? null,
        );
    }
}
