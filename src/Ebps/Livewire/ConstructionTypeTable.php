...
use Src\Ebps\Exports\ConstructionTypesExport;
use Src\Ebps\Models\ConstructionType;
use Src\Ebps\Service\ConstructionTypeAdminService;

class ConstructionTypeTable extends DataTableComponent
{
    use SessionFlash;
    protected $model = ConstructionType::class;
    ...
    public function edit($id)
    {
        ...
        // return redirect()->route('admin.ebps.construction_types.edit',['id'=>$id]);
    }
    public function delete($id)
    {
        ...
        $service->delete(ConstructionType::findOrFail($id));
    ...
    public function exportSelected(){
        ...
        $this->clearSelected();
        return Excel::download(new ConstructionTypesExport($records), 'construction_types.xlsx');
    }
}
