...
class MapPassGroupTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
     $columns = [
        ...
        if (can('ebps_map_pass_groups edit') || can('ebps_map_pass_groups delete')) {
            $actionsColumn = Column::make(__('ebps::ebps.actions'))->label(function ($row, Column $column) {
                $buttons = '';

                if (can('ebps_map_pass_groups edit')) {
                    $edit = '<button class="btn btn-primary btn-sm" wire:click="edit(' . $row->id . ')" ><i class="bx bx-edit"></i></button>&nbsp;';
                    $buttons .= $edit;
                }

                if (can('ebps_map_pass_groups delete')) {
    ...
    public function edit($id)
    {
        ...
        return redirect()->route('admin.ebps.map_pass_groups.edit',['id'=>$id]);
    }
    public function delete($id)
    {
        ...
        $service->delete(MapPassGroup::findOrFail($id));
        $this->successFlash(__('ebps::ebps.map_pass_group_deleted_successfully'));
    }
    ...
    public function exportSelected(){
        ...
        $this->clearSelected();
        return Excel::download(new MapPassGroupsExport($records), 'map_pass_groups.xlsx');
    }
}
