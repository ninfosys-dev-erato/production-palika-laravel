...
class LandUseAreaTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
     $columns = [
        ...
        if (can('ebps_land_use_areas edit') || can('ebps_land_use_areas delete')) {
            $actionsColumn = Column::make(__('ebps::ebps.actions'))->label(function ($row, Column $column) {
                $buttons = '';

                if (can('ebps_land_use_areas edit')) {
                    $edit = '<button class="btn btn-primary btn-sm" wire:click="edit(' . $row->id . ')" ><i class="bx bx-edit"></i></button>&nbsp;';
                    $buttons .= $edit;
                }

                if (can('ebps_land_use_areas delete')) {
    ...
    public function edit($id)
    {
        ...
        $this->dispatch('edit-land-use-area', $id);
        // return redirect()->route('admin.ebps.land_use_areas.edit',['id'=>$id]);
    }
    public function delete($id)
    {
        ...
        $service->delete(LandUseArea::findOrFail($id));
        $this->successFlash(__('ebps::ebps.land_use_area_deleted_successfully'));
    }
    ...
    public function exportSelected(){
        ...
        $this->clearSelected();
        return Excel::download(new LandUseAreasExport($records), 'land_use_areas.xlsx');
    }
}
