...
class OrganizationForm extends Component
{
    ...
    {       
        ...
        $this->organizationDetail['status'] = OrganizationStatusEnum::ACCEPTED;
        ...
        try{
            ...
            DB::commit();
            $this->successFlash('तपाईंको संस्था/परामर्शदाता सफलतापूर्वक दर्ता गरिएको छ। सेवा प्रयोग गर्न कृपया प्रमाणीकरण इमेलको प्रतीक्षा गर्नुहोस्।');
            return redirect()->route('admin.ebps.organizations.index');
        }  catch (\Exception $e) {
    ...
    {
        return view("Ebps::livewire.organization.organization-form");
    }
