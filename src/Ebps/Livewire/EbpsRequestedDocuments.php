...
class EbpsRequestedDocuments extends Component{
    ...
    {
        return view('Ebps::livewire.documents');
    }
    ...
    public function save(int $index)
    {
        ...
        if($result){
            $this->successToast(__('ebps::ebps.businessregistrationbusinessregistrationdocument_saved_successfully'));
        }else{
            $this->errorToast(__('ebps::ebps.businessregistrationbusinessregistrationdocument_saving_failed'));
        }
    }
