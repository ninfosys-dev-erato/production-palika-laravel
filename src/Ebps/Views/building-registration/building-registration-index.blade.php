<x-layout.app header="Building Registration List">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('admin.ebps.building-registrations.create') }}" class="btn btn-info"><i
                                class="bx bx-plus"></i>
                ...
                <div class="card-body">
                    <livewire:ebps.building_registration_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
