<x-layout.app header="ConstructionType List">
    ...
    <div class="row g-6">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:ebps.construction_type_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <livewire:ebps.construction_type_form :action="App\Enums\Action::CREATE" />
