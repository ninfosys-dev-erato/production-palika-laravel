                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input dusk="businessregistration-documents.{{ $key }}.document_name-field"
                    ...
                    <div class="col-md-3" wire:target="documents.{{ $key }}.document">
                        <div class="form-group">
                            ...
                            <select dusk="businessregistration-documents.{{ $key }}.document_status-field"
                    ...
                    <div class="col-md-1">
                        <div class="btn-group-vertical">
                            ...
                            <button class="btn btn-danger" wire:click="removeDocument({{ $key }})"> <i
