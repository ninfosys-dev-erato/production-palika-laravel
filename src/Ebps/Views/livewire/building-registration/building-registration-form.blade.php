    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="divider divider-primary text-start text-primary font-14">
                <div class="divider-text ">{{ __('ebps::ebps.building_description') }}</div>
            </div>
        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-start mt-3 pb-2">
                <p class="btn btn-info" wire:click="addDocument"><i class="bx bx-plus"></i> Add
                    Document</p>
            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-1">
                                <div class="btn-group-vertical">
                                    <button class="btn btn-danger" wire:click="removeDocument({{ $key }})">
