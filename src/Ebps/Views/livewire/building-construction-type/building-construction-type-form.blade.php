<form wire:submit.prevent="save">
        ...
        <div class="row">
            <div class='col-md-6'>
                <div class='form-group'>
                    ...
                    <input wire:model='buildingConstructionType.title' name='title' type='text' class='form-control'
                        placeholder="{{ __('ebps::ebps.enter_title') }}">
                    <div>
                        @error('buildingConstructionType.title')
    ...
    <div class="card-footer">
        ...
        <a href="{{ route('admin.ebps.building_construction_types.index') }}" wire:loading.attr="disabled"
