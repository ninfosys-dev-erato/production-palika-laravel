    ...
    @if($this->canApproveAllSteps())
        <div class="d-flex justify-content-end mb-4">
            <button wire:click="showConfirmation" class="btn btn-success btn-lg">
                ...
                {{ __('ebps::ebps.approve_all_steps') }}
            </button>
        </div>
    @endif
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            ...
                            {{ __('ebps::ebps.confirm_approve_all_steps') }}
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            ...
                            {{ __('ebps::ebps.are_you_sure_approve_all_steps') }}
                        </div>
                        <p class="mb-0">
                            {{ __('ebps::ebps.this_action_will_approve_all_before_steps_at_once') }}
                        </p>
                    </div>
