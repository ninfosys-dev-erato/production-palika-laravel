<form wire:submit.prevent="save">
        ...
        <div class="row">
            <div class='col-md-6'>
                <div class='form-group'>
                    ...
                    <input wire:model='landUseArea.title' name='title' type='text' class='form-control'
                        placeholder="{{ __('ebps::ebps.enter_title') }}">
                    <div>
                        @error('landUseArea.title')
    ...
    <div class="card-footer">
        ...
        <a href="{{ route('admin.ebps.land_use_areas.index') }}" wire:loading.attr="disabled"
