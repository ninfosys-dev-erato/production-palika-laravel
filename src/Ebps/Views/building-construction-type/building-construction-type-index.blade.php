<x-layout.app header="BuildingConstructionType List">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    @perm('ebps_settings create')
                        ...
                        <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                            ...
                            <i class="bx bx-plus"></i> {{ __('ebps::ebps.add_building_construction_type') }}
                        </button>
                    @endperm
                </div>
                <div class="card-body">
                    <livewire:ebps.building_construction_type_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade " id="indexModal" tabindex="-1" aria-labelledby="AddBuildingConstructionTypesModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddBuildingConstructionTypesModalLabel">
                        {{ __('ebps::ebps.building_construction_type') }}
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <livewire:ebps.building_construction_type_form :action="App\Enums\Action::CREATE" />
