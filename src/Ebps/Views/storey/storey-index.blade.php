<x-layout.app header="Storey List">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    @perm('ebps_settings create')
                        ...
                        <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                            ...
                            <i class="bx bx-plus"></i> {{ __('ebps::ebps.add_storey') }}
                        </button>
                    @endperm
                </div>
                <div class="card-body">
                    <livewire:ebps.storey_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade " id="indexModal" tabindex="-1" aria-labelledby="AddStoreyModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddStoreyModalLabel">
                        {{ __('ebps::ebps.storey') }}
                    </h5>
                ...
                <div class="modal-body">
                    <livewire:ebps.storey_form :action="App\Enums\Action::CREATE" />
