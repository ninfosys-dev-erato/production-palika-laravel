<x-layout.app header="MapImportantDocument List">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a href="#">{{ __('ebps::ebps.mapimportantdocument') }}</a>
            </li>
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    @perm('map_important_documents_create')
                        ...
                        <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                            ...
                            <i class="bx bx-plus"></i> {{ __('ebps::ebps.add_map_important_document') }}
                        </button>
                    @endperm
                </div>
                <div class="card-body">
                    <livewire:ebps.map_important_document_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade " id="indexModal" tabindex="-1" aria-labelledby="AddMapImportantDocumentModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddMapImportantDocumentModalLabel">
                        {{ __('ebps::ebps.map_important_document') }}
                    </h5>
                ...
                <div class="modal-body">
                    <livewire:ebps.map_important_document_form :action="App\Enums\Action::CREATE" />
