<x-layout.app header="MapApply List">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('ebps::ebps.old_map_applications') }}</a>
            </li>
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between">
                    <h5 class="text-primary fw-bold mb-0">
                        {{ __('ebps::ebps.old_map_applications') }}
                    </h5>

                    <div>
                        <a href="{{ route('admin.ebps.old_applications.create') }}" class="btn btn-info"><i
                                class="bx bx-plus"></i>
                            {{ __('ebps::ebps.add_old_map_applications') }}</a>
                    </div>

                </div>
                <div class="card-body">
                    <livewire:ebps.old_map_application_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
