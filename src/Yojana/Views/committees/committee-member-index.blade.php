<x-layout.app header="{{ __('yojana::yojana.committeemember_list') }}">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="text-primary fw-bold">{{ __('yojana::yojana.committee_member_list') }}</h5>

                    @perm('committee_member_create')
                        <div>
                            <a href="{{ route('admin.committee-members.create') }}" class="btn btn-info"><i
                                    class="bx bx-plus"></i> {{ __('yojana::yojana.add_committee_member') }}</a>
                        </div>
                    @endperm
