<x-layout.app header="{{ __('yojana::yojana.project_incharge_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a href="#">{{ __('yojana::yojana.project_incharge') }}</a>
            </li>
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:yojana.project_incharge_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">
                        {{ __('yojana::yojana.manage_project_incharge') }}
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="resetForm()"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <livewire:yojana.project_incharge_form :action="App\Enums\Action::CREATE" />
                </div>
            </div>
        </div>
    </div>
