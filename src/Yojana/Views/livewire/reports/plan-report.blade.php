<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary fw-bold mb-0">{{ __('yojana::yojana.plan_report') }}</h4>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model="startDate" id="start_date"
                                    class="form-control border-start-0 nepali-date" placeholder="{{ __('yojana::yojana.start_date') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model="endDate" id="end_date"
                                    class="form-control border-start-0 nepali-date" placeholder="{{ __('yojana::yojana.end_date') }}">
                            </div>
                        </div>
