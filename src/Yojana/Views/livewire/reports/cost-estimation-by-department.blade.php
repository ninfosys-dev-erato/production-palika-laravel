<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary fw-bold mb-0">{{ __('yojana::yojana.cost_estimation_and_payment_report_according_to_branch_or_department') }}</h4>
    ...
    <div class="container py-4">
        <div class="card border-0 shadow-sm rounded-3">
            <div class="divider divider-primary text-start text-primary fw-bold mx-4 mb-0">
                <div class="divider-text fw-bold fs-6">{{ __('yojana::yojana.search') }}</div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-12">
                            <label class="form-label">{{ __('yojana::yojana.departments') }}</label>
                            <select class="form-select" wire:model="selectedBranch">
