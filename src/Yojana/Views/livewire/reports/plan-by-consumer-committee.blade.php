<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary fw-bold mb-0">{{ __('yojana::yojana.plan_report_according_to_consumer_committee') }}</h4>
                ...
                <div class="container-fluid">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-12">
                            <label class="form-label">{{ __('yojana::yojana.consumer_committee') }}</label>
                            <select class="form-select" wire:model="selectedConsumerCommittee">
                            ...
                            <div>
                                @error('selectedConsumerCommittee')
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($query as $index=>$row)
                            <tr>
                                ...
                                @php
                                    $chair = optional($row->implementationAgency?->consumerCommittee?->committeeMembers)->firstWhere('designation', 'chair');
                                @endphp
