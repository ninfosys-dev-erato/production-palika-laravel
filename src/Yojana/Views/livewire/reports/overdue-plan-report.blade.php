<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary fw-bold mb-0">{{ __('yojana::yojana.overdue_plan_report') }}</h4>
                        ...
                        <tbody>
                            @foreach ($plans as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <td>{{ replaceNumbers($row->agreement->plan_start_date_ne, true) }}</td>
                                    <td>{{ replaceNumbers($row->agreement->plan_completion_date_ne, true) }}</td>
