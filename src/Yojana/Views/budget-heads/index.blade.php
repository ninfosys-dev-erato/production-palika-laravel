<x-layout.app header="{{ __('yojana::yojana.budget_head_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a
                    href="{{ route('admin.plan.index') }}">{{ __('yojana::yojana.plan_management') }}</a>
            <li class="breadcrumb-item"><a href="#">{{ __('yojana::yojana.budget_head') }}</a>
            </li>
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:yojana.budget_head_table theme="bootstrap-4" />
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="taskModalLabel">
                        ...
                        {{ __('yojana::yojana.manage_budget_head') }}
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        @if (isset($budgetHead))
                            <livewire:yojana.budget_head_form :action="App\Enums\Action::UPDATE" :$budgetHead />
                        @else
                            <livewire:yojana.budget_head_form :action="App\Enums\Action::CREATE" />
                        @endif
                    </div>
                </div>
            </div>
