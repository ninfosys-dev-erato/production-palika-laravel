<x-layout.app header="{{ __('yojana::yojana.agreement_cost_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a href="#">{{ __('yojana::yojana.agreement_cost') }}</a>
            </li>
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:yojana.agreement_cost_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
