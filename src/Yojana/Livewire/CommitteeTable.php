...
use Src\Yojana\Exports\CommitteesExport;
...
class CommitteeTable extends DataTableComponent
{
    ...
    {
        $columns = [
            Column::make(__('yojana::yojana.committee_type'), "committeeType.name")->sortable()->searchable()->collapseOnTablet(),
            Column::make(__('yojana::yojana.committee_name'), "committee_name")->sortable()->searchable()->collapseOnTablet(),
        ];
    ...
    public function edit($id)
    {
        ...
        $this->dispatch('edit-committee', $id);
