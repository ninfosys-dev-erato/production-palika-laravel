...
class ReportPlanByCompletion extends Component
{
    ...
    {
        return view("Yojana::livewire.reports.plan-by-completion");
    }
    ...
    public function mount()
    {
        ...
        $this->plans = Plan::whereNull('deleted_at')->where('status', PlanStatus::Completed)->with('planArea', 'expenseHead', 'budgetSources.expenseHead', 'latestPayment')->get();
    ...
    {
        $this->validate();
        $query = Plan::whereNull('deleted_at')->where('status', PlanStatus::Completed)->with('planArea', 'expenseHead', 'budgetSources.expenseHead', 'latestPayment');
    ...
    public function downloadPdf()
    {
        try {
            ...
            $html = view('Yojana::livewire.reports.pdf.pdf-plan-by-completion', compact('nepaliDate',  'plans', 'header'))->render();
