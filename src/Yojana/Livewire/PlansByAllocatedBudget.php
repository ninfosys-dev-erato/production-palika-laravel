...
class PlansByAllocatedBudget extends Component
{
    ...
    {
        return view("Yojana::livewire.reports.plans-by-allocated-budget");
    }
    ...
    public function search()
    {
        ...
        if ($this->minAmount && $this->maxAmount) {
            $query->whereBetween('allocated_budget', [$this->minAmount, $this->maxAmount]);
        }
        ...
        if ($this->type) {
            $query->where('category', $this->type);
        }
    ...
    public function downloadPdf()
    {
        try {
            ...
            $html = view('Yojana::livewire.reports.pdf.pdf-plan-by-allocated-budget', compact('nepaliDate',  'startDate', 'endDate', 'plans', 'header'))->render();
