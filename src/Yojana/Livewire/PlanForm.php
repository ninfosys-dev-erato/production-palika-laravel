...
class PlanForm extends Component
{
    ...
    public function rules(): array
    {
        return [
            ...
            'plan.implementation_method_id' => ['required'],
            'plan.location' => ['required'],
            'plan.ward_id' => ['required'],
            'plan.start_fiscal_year_id' => ['required'],
            'plan.operate_fiscal_year_id' => ['required'],
            'plan.area_id' => ['required'],
            'plan.sub_region_id' => ['required'],
            'plan.targeted_id' => ['required'],
            'plan.implementation_level_id' => ['required'],
            'plan.plan_type' => ['required'],
            'plan.nature' => ['required'],
