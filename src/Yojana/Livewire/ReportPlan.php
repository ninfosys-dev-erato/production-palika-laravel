...
class ReportPlan extends Component
{
    ...
    {
        return view("Yojana::livewire.reports.plan-report");
    }
    ...
    public function downloadPdf()
    {
        try {
            ...
            $html = view('Yojana::livewire.reports.pdf.plan-report', compact('nepaliDate',  'startDate', 'endDate', 'plans', 'header'))->render();
