...
class WardPlanByArea extends Component
{
    ...
    {
        return view("Yojana::livewire.reports.ward-plan-by-area");
    }
    ...
    public function mount()
    {
        ...
        $this->query = Ward::whereNull('deleted_at')
            ->whereHas('plans')
            ->with('plans.costEstimation', 'plans.agreement.agreementCost', 'plans.payments')
            ->get();
    }
    ...
    public function downloadPdf()
    {
        try {
            ...
            $query->load('plans.costEstimation', 'plans.agreement.agreementCost', 'plans.payments');
            ...
            $html = view('Yojana::livewire.reports.pdf.pdf-ward-plan-by-area-report', compact('nepaliDate',  'startDate', 'endDate', 'query', 'header'))->render();
