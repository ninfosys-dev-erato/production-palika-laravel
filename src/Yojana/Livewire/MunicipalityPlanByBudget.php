...
class MunicipalityPlanByBudget extends Component
{
    ...
    {
        return view("Yojana::livewire.reports.municipality-plan-by-budget");
    }
    ...
    public function downloadPdf()
    {
        try {
            ...
            $html = view('Yojana::livewire.reports.pdf.pdf-municipality-plan-budget', compact('nepaliDate',  'startDate', 'endDate', 'query', 'header'))->render();
