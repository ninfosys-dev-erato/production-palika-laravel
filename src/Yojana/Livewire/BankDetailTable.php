...
//        return redirect()->route('admin.bank_details.edit',['id'=>$id]);
        $this->dispatch('edit-bank-detail', $id);
    }
    public function delete($id)
    {
        ...
        $service->delete(BankDetail::findOrFail($id));
    ...
    public function exportSelected(){
        ...
        $this->clearSelected();
        return Excel::download(new BankDetailsExport($records), 'bank_details.xlsx');
    }
}
