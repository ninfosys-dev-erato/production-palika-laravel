...
class UserTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        $columns = [
            ...
            Column::make("Email", "email")
                ->searchable(),
            Column::make(__('users::users.change_status'), 'active')
        ...
        if (can('users_edit') || can('users_delete') || can('users_manage')) {
            $actionsColumn = Column::make(__('users::users.actions'))->label(function ($row, Column $column) {
                $buttons = '';
    ...
    public function edit($id)
    {
        if (!can('users_edit')) {
            ...
            $this->errorFlash(__('users::users.you_cannot_perform_this_action'));
            return false;
        }
