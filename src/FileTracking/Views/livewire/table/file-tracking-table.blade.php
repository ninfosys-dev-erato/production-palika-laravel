    ...
    <div {{ $this->getTopLevelAttributes() }}>
        ...
        <x-livewire-tables::wrapper :component="$this" :tableName="$tableName" :$primaryKey :$isTailwind :$isBootstrap :$isBootstrap4 :$isBootstrap5>
            ...
            <x-livewire-tables::table>
                ...
                <thead class="">
                <tr>
                    <td rowspan="2">दर्ता नं</td>
                    <td rowspan="2">दर्ता मिति</td>
                    <td colspan="3" class="text-center">पत्र प्राप्त भएको</td>
                    <td rowspan="2">पत्र पठाउने ब्यक्ति वा कार्यालयको नाम</td>
                    <td rowspan="2">ठेगाना</td>
                    <td rowspan="2">बिषय</td>
                    <td rowspan="2">बुझाउने शाखा वा फाँट</td>
                    <td rowspan="2">फर्स्यौट शाखा</td>
                        <td rowspan="2">कार्यहरू</td>
                </tr>
                <tr>
                    <td>पत्र संख्या</td>
                    <td>च.नं</td>
