<x-layout.app header="FileRecordLog List">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="text-primary fw-bold mb-0">
                        {{ __('filetracking::filetracking.file_record_logs') }}
                    </h5>
                    @perm('file_record_logs create')
                        <div>
                            <a href="{{ route('admin.file_records.create') }}" class="btn btn-info"><i
                                    class="bx bx-plus"></i>
                                {{ __('filetracking::filetracking.add_file_record_log') }}</a>

                        </div>
                    @endperm
                </div>
                <div class="card-body">
                    <livewire:file_tracking.file_record_log_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
