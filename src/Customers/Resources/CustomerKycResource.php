...
class CustomerKycResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'document_image1' => ImageServiceFacade::getImage(config('src.CustomerKyc.customerKyc.path'),$this->document_image1,'local'),
            'document_image2' => ImageServiceFacade::getImage(config('src.CustomerKyc.customerKyc.path'),$this->document_image2,'local'),
