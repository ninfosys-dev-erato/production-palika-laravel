...
<x-layout.app header="Customer Detail">
    <div class="container">

        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
                <li class="breadcrumb-item"><a href="#">{{ __('Customer Detail') }}</a>
                </li>
            </ol>
        </nav>
        <div class="col-md-12">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.customer.index') }}" class="btn btn-info"><i
                        class="bx bx-list-ul"></i>{{ __('Customer List') }}</a>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-stretch">
                            <div class="card-body border shadow-lg bg-white flex-fill" style="border-radius: 10px;">
                                @if ($customer->avatar)
                                    <img src="{{ customFileAsset(config('src.Customers.customer.avatar_path'), $customer->avatar, getStorageDisk('public'), 'tempUrl') }}"
                        ...
                        @perm('customer access')
                            @if ($customer->kyc->status->value !== 'accepted')
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <div class="card mt-3 border shadow-sm bg-light" style="border-radius: 10px;">
                                            <div class="card-body">
                                                <livewire:customers.customer_detail_change_status_form :customer="$customer"
                                                    :customerKyc="$customer->kyc" :action="\App\Enums\Action::UPDATE" />
                            ...
                            @endif
                        @endperm
                        <livewire:customers.customer_detail_kyc_verification_logs :customerKycId="$customer->id" />
                    </div>
                </div>
            @else
