...
Route::group(['prefix' => 'admin/employees', 'as' => 'admin.employee.', 'middleware' => ['web', 'auth']], function () {
    Route::get('/branch', [BranchController::class, 'index'])->name('branch.index')->middleware('permission:branch access');
    Route::get('/branch/create', [BranchController::class, 'create'])->name('branch.create')->middleware('permission:branch create');
    Route::get('/branch/edit/{id}', [BranchController::class, 'edit'])->name('branch.edit')->middleware('permission:branch edit');
    Route::get('/branch/delete/{id}', [BranchController::class, 'delete'])->name('branch.delete')->middleware('permission:branch delete');
    Route::get('/branch/employee/{branchname}', [BranchController::class, 'showEmployee'])->name('branch.showemployee');

    Route::get('/designation', [DesignationController::class, 'index'])->name('designation.index')->middleware('permission:designation access');
    Route::get('/designation/create', [DesignationController::class, 'create'])->name('designation.create')->middleware('permission:designation create');
    Route::get('/designation/edit/{id}', [DesignationController::class, 'edit'])->name('designation.edit')->middleware('permission:designation edit');
