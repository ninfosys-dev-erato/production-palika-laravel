...
class BerujuEntryDto
{
    ...
    public static function fromLiveWireModel(BerujuEntry $berujuEntry): BerujuEntryDto
    {
        return new self(
            ...
            audit_type: $berujuEntry->audit_type?->value ?? $berujuEntry->audit_type ?? BerujuAduitTypeEnum::INTERNAL_AUDIT->value,
            entry_date: $berujuEntry->entry_date ?? '',
            reference_number: $berujuEntry->reference_number ?? '',
            contract_number: $berujuEntry->contract_number ?? '',
            branch_id: $berujuEntry->branch_id ?? '',
            project: $berujuEntry->project ?? '',
            beruju_category: $berujuEntry->beruju_category?->value ?? $berujuEntry->beruju_category ?? BerujuCategoryEnum::THEORETICAL_BERUJU->value,
            sub_category_id: $berujuEntry->sub_category_id ?? '',
            amount: $berujuEntry->amount ?? null,
            currency_type: $berujuEntry->currency_type?->value ?? $berujuEntry->currency_type ?? BerujuCurrencyTypeEnum::NPR->value,
