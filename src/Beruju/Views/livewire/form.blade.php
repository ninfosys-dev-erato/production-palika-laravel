                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.fiscal_year_id"
                            class="form-select @error('berujuEntry.fiscal_year_id') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.audit_type"
                            class="form-select @error('berujuEntry.audit_type') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input wire:model="berujuEntry.entry_date" type="text"
                            class="form-control nepali-date @error('berujuEntry.entry_date') is-invalid @enderror"
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.branch_id"
                            class="form-select @error('berujuEntry.branch_id') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input wire:model="berujuEntry.project_id" type="text"
                            class="form-control @error('berujuEntry.project_id') is-invalid @enderror"
                            placeholder="{{ __('beruju::beruju.enter_project_id') }}">
                        {{-- <select wire:model="berujuEntry.project_id"
                            class="form-select @error('berujuEntry.project_id') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.beruju_category"
                            class="form-select @error('berujuEntry.beruju_category') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.sub_category_id"
                            class="form-select @error('berujuEntry.sub_category_id') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input wire:model="berujuEntry.amount" type="number" step="0.01"
                            class="form-control @error('berujuEntry.amount') is-invalid @enderror"
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <select wire:model="berujuEntry.currency_type"
                            class="form-select @error('berujuEntry.currency_type') is-invalid @enderror">
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input wire:model="berujuEntry.legal_provision" type="text"
                            class="form-control @error('berujuEntry.legal_provision') is-invalid @enderror"
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <input wire:model="berujuEntry.action_deadline" type="text"
                            class="form-control nepali-date @error('berujuEntry.action_deadline') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea wire:model="berujuEntry.description" rows="5"
                            class="form-control @error('berujuEntry.description') is-invalid @enderror"
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        ...
                        <textarea wire:model="berujuEntry.notes" rows="5"
                            class="form-control @error('berujuEntry.notes') is-invalid @enderror"
