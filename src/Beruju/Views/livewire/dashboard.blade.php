        ...
        <div class="col-12">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="flex-grow-1 d-flex align-items-center">
                    <span class="fw-bold fs-6 text-primary me-2">
                        {{ __('beruju::beruju.filter_by') }}
                    </span>
                    <div class="flex-grow-1 border-bottom border-primary"></div>
                </div>

                <!-- Select box at the end -->
                <div class="ms-3" style="min-width: 200px;">
                    <select name="fiscalyear" id="fiscalyear" wire:model="selectedFiscalYear" class="form-select"
                        wire:change="updateFiscalYear">
                        <option value="">{{ __('beruju::beruju.all_fiscal_year') }}</option>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center bg-light rounded-0">
                        ...
                        <div class="d-flex align-items-center">
                            <span class="badge bg-primary me-2">
                                ...
                                {{ replaceNumbersWithLocale(collect($berujuByFiscalYear)->sum('total_count'), true) }}
                            </span>
                        </div>
                    </div>
                    <div class="card-body m-0 p-2">
