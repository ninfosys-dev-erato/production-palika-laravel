        ...
        <div class="row">
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <input wire:model='actionType.name_eng' name='name_eng' type='text' class='form-control'
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <input wire:model='actionType.name_nep' name='name_nep' type='text' class='form-control'
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <select wire:model='actionType.sub_category_id' name='sub_category_id' class='form-control'>
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <input wire:model='actionType.form_id' name='form_id' type='number' class='form-control'
            ...
            <div class='col-md-12 mb-3'>
                <div class='form-group'>
                    ...
                    <textarea wire:model='actionType.remarks' name='remarks' class='form-control' rows='3'
