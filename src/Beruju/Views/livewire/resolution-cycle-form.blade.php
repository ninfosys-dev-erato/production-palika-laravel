    ...
    <form wire:submit="save">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select wire:model="resolutionCycle.incharge_id" id="incharge_id" class="form-select @error('resolutionCycle.incharge_id') is-invalid @enderror">
            ...
            <div class="col-md-6 mb-3">
                ...
                <textarea wire:model="resolutionCycle.remarks" id="remarks" rows="3" 
                          class="form-control @error('resolutionCycle.remarks') is-invalid @enderror"
        ...
        <div class="d-flex justify-content-end gap-2">
            <button type="button" class="btn btn-secondary" wire:click="resetResolutionCycle">
