    ...
    @else
        <form wire:submit="save">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select wire:model="berujuAction.action_type_id" id="action_type_id" class="form-select rounded-0 @error('berujuAction.action_type_id') is-invalid @enderror">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select wire:model="berujuAction.status" id="status" class="form-select rounded-0 @error('berujuAction.status') is-invalid @enderror">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" 
                       ...
                       id="resolved_amount" 
                       class="form-control rounded-0 @error('berujuAction.resolved_amount') is-invalid @enderror"
        ...
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <textarea wire:model="berujuAction.remarks" id="remarks" rows="3" 
                          class="form-control rounded-0 @error('berujuAction.remarks') is-invalid @enderror"
        ...
        <div class="d-flex justify-content-end gap-2">
            <button type="button" wire:click="resetAction" class="btn btn-secondary rounded-0">
