                ...
                <div class="card shadow" id="printContent">
                    ...
                    <div class="card-header bg-white border-0">
                        ...
                        <div class="text-center mt-3 mb-5">
                            ...
                            <h5 class="mb-3"><strong>{!! 'आन्तरिक/अन्तिम लेखापरीक्षणबाट कायम बेरुजुको लगत खाता (म.ले.प.फा.नं. ८०१)' !!}</strong></h5>
                        </div>

                            <!-- Left Side - Government Hierarchy -->
                            <div class="col-md-3 ">
                                <div class="text-start">
                                    <div class="border border-dark p-4 col-md-6">
                                        <p class="mb-1"><strong>{!! 'नेपाल सरकार/' !!}</strong></p>
                       ...
                       <div class="row">
                        <div class="col-md-12 text-center">
                            <p class="mb-1"><strong>{!! 'आन् तररक/अवन् ति लेखापरीक्ष णबाट कायि बेरु जनको लगत खाता' !!}</strong></p>
                            ...
                            <div class="col-md-6 text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="me-3">
                                        ...
                                        <input type="checkbox" class="form-check-input me-1 ms-2"> <strong>{!! 'राजस्व' !!}</strong>
                                    </div>
                                    <div class="me-3">
                                        <input type="checkbox" class="form-check-input me-1"> <strong>{!! 'धरौटी' !!}</strong>
                                        <input type="checkbox" class="form-check-input me-1 ms-2"> <strong>{!! 'अन्य कोष' !!}</strong>
                                    </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($berujuEntries as $index => $row)
                                <tr>
                                    ...
                                    <td>{{ replaceNumbersWithLocale($row->dafa_number, true) ?? __('beruju::beruju.na') }}</td>
                                    <td>{{ replaceNumbersWithLocale($row->reference_number, true) ?? __('beruju::beruju.na') }}</td>
                                    <td>{{$row->name}}</td>
                                    <td>{{ $row->owner_name ?? __('beruju::beruju.na') }}</td>
                                    <td>{{ replaceNumbersWithLocale($row->contract_number, true) ?? __('beruju::beruju.na') }}</td>
                                    ...
                                    <td>{{ replaceNumbersWithLocale(number_format((float)$row->amount, 2), true) }}</td>
                                   ...
                                   <td>{{ replaceNumbersWithLocale(number_format((float)$row->resolved_amount, 2), true) }}</td>
                                   ...
                                   <td>
                                    ...
                                    <td>{{ replaceNumbersWithLocale(number_format((float)$row->remaining_amount, 2), true) }}</td>
                ...
                <div class="card-footer bg-white border-0">
                    ...
                    <div class="mt-4 mb-4">
                        <p class="mb-2"><strong>{!! 'नोटः' !!}</strong>
                            {!! 'आन्तरिक लेखा परीक्षण र अन्तिम लेखा परीक्षण बेरुजुको लगत छुट्टा छुट्टै खातामा राख्नु पर्दछ। साथै कारोबारको प्रकृतिअनुसार छुट्टा छुट्टै पानामा अभिलेख राख्नुपर्दछ ।' !!}
                        </p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <p class="mb-1 p-3">
                        ...
                        {!! '१	एक कार्यालयको एकभन्दा बढी उपशीर्षकको बेरुजु भए एकपछि अर्को उपशीर्षकको बेरुजु देखिने गरी लगत राख्ने गर्नुपर्दछ ।' !!}<br>					
                        {!! '२	विनियोजन, राजस्व र धरौटीको बेरुजुको अभिलेख राख्दा फरक फरक पाना नं. उल्लेख गरी अभिलेख राख्नुपर्छ ।' !!}<br>									
                        {!! '३	यस खाता प्रत्येक आर्थिक वर्षका लागि राखिन्छ । त्यसैले यस खाता कुन साल  र कुन महिनाका लागि यस खाता राखिएको हो सो साल र महिना लेख्नुपर्छ ।' !!}<br>										
                        {!! '४	बेरुजुको विवरण बारम्बार प्रयोग हुने अवस्थामा छुट्टै सहायक खाता यही ढाँचामा तयार गर्नुपर्नेछ जस्तै मोबिलाइजेसन पेस्की' !!}<br>										
                        {!! '५	आर्थिक वर्षमा चालु आर्थिक वर्ष लेख्नुपर्छ ।' !!}<br>										
                        {!! '६	खाता पाना नं. मा प्रत्येक आर्थिक वर्षका लागि १ बाट सुरु गरी सिलसिलेबार रूपमा खाता पाना नं. लेख्नुपर्छ ।' !!}<br>										
                        {!! '७	बजेट उपशीर्षक/कारोबार नं. मा आर्थिक सङ्केत तथा वर्गीकरण र व्याख्यामा उल्लेख भएबमोजिमको बजेट उपशीर्षक नं. लेख्नुपर्छ ।' !!}<br>										
                        {!! '८	कायम बेरुजुको लगत कुन प्रकारको बेरुजु हो सो को प्रकृतिअनुसार विनियोजन, राजस्व, धरौटी वा अन्य कोष मध्ये कुन हो सोको प्रकारमा कुनै एकमा ठिक चिह्न लगाउनुपर्छ र ठिक चिह्न जुन प्रकारमा लगाइन्छ सोही प्रकारको अभिलेख राख्नुपर्ने हुन्छ ।' !!}<br>									
                        ...
                        {!! '१५	महल ७, ८ र ९ मा कायम भएको बेरुजुको प्रकार अनुसार क्रमशः नियमित गर्नुपर्ने बेरुजु, पेस्की बेरुजु र असुल उपर गर्नुपर्ने बेरुजु रकम लेख्नुपर्छ ।' !!}<br>									
                        {!! '१६	महल १० मा महल ७ को नियमित गर्नुपर्ने बेरुजु, महल ८ को पेस्की बेरुजु र महल ९ को असुल उपर गर्नुपर्ने बेरुजुको जोड जम्मा लेख्नुपर्छ ।' !!}<br>									
                        {!! '१७	महल ११, १२, १३ र १४ मा संपरीक्षण भएको बेरुजुको विवरण राख्नुपर्छ । यसमा क्रमशः सम्परीक्षण मिति, सम्परीक्षण भएको नियमित गर्नुपर्ने बेरुजु, पेस्की बेरुजु र असुलउपर गर्नुपर्ने बेरुजु रकम लेख्नुपर्छ ।' !!}<br>									
                        {!! '१८	महल १५ मा सम्परीक्षण भएको जोड जम्मा बेरुजु रकम लेख्नुपर्छ ।' !!}<br>									
                        {!! '१९	महल १६, १७, १८ र १९  मा सम्परीक्षण हुन बाँकी बेरुजु रकम लेख्नुपर्छ । यसमा क्रमशः नियमित गर्नुपर्ने बेरुजु, पेस्की बेरुजु, असुल उपर गर्नुपर्ने बेरुजु र जोड जम्मा बाँकी बेरुजु रकम लेख्नुपर्छ ।' !!}<br>									
                        {!! '२०	महल २० मा कुनै कैफियत भएमा सो कैफियत उल्लेख गर्नुपर्छ ।' !!}<br>									
                        {!! '२१	जम्मा हरफमा रकमहरूको जोड जम्मा राख्नुपर्दछ ।' !!}<br>									
                        {!! '२२	बेरुजु अभिलेख तयार गर्ने तथा प्रमाणित गर्नेको नाम, पद र मिति लेखेर  हस्ताक्षर गर्नुपर्छ ।' !!}<br>									
                    </p>
                </div>
            </div>
        </div>
