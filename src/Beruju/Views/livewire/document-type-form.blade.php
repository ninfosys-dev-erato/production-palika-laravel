        ...
        <div class="row">
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <input wire:model='documentType.name_eng' name='name_eng' type='text' class='form-control rounded-0'
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    ...
                    <input wire:model='documentType.name_nep' name='name_nep' type='text' class='form-control rounded-0'
            ...
            <div class='col-md-12 mb-3'>
                <div class='form-group'>
                    ...
                    <textarea wire:model='documentType.remarks' name='remarks' class='form-control rounded-0' rows='3'
