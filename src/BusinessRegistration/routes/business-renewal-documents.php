...
Route::group(['prefix' => 'admin/business-renewal-documents', 'as' => 'admin.business_renewal_documents.', 'middleware' => ['web', 'auth', 'check_module:business_regsitration']], function () {
