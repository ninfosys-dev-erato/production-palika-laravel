...
<body>
    ...
    <div>
        <p>जो जस सँग सम्बन्ध छ |</p>

    </div>
    <div>
        प्रस्तुत बिषयमा आज मिति {{ $startDate }} देखि {{ $endDate }} यस कार्यालयमा भए गरेको कार्य सम्पादन
        विवरण तपसिल
        बमोजिम रहेको व्यहोरा अनुरोध छ |
        <p>तपसिल:</p>
    </div>
    ...
    <table class="min-w-full bg-white">
        <thead>
            <tr class="bg-gray-100">
                ...
                <th class="py-2 px-4 border">शाखाहरु</th>
                <th class="py-2 px-4 border">सेवाग्राहीको संख्या</th>
            ...
            @foreach ($reports as $token)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-2 px-4 border">
                        @foreach ($token['purposes'] as $purpose)
                            <div class="py-2 px-4 border">{{ $purpose['purpose'] }} :
                                {{ replaceNumbers($purpose['total_tokens'], true) }}
                            </div>
                        @endforeach
                    </td>
