<x-layout.app header="{{ __('tokentracking::tokentracking.register_token_log_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a href="#">{{ __('tokentracking::tokentracking.register_token_log') }}</a>
            </li>
    ...
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <livewire:token_tracking.register_token_log_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
