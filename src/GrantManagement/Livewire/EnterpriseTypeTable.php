...
Column::make(__('grantmanagement::grantmanagement.title_en'), "title_en") ->sortable()->searchable()->collapseOnTablet(),
    ...
    public function edit($id)
    {
        ...
        $this->dispatch('edit-enterprise-type', $id);
        // return redirect()->route('admin.enterprise_types.edit',['id'=>$id]);
    }
    public function delete($id)
    {
        ...
        $service->delete(EnterpriseType::findOrFail($id));
        $this->successFlash(__('grantmanagement::grantmanagement.enterprise_type_deleted_successfully'));
    }
    ...
    public function exportSelected(){
        ...
        $this->clearSelected();
        return Excel::download(new GrantManagementExport($records), 'enterprise-types.xlsx');
    }
}
