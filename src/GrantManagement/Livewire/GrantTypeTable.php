...
class GrantTypeTable extends DataTableComponent
{
    ...
    public function edit($id)
    {
        ...
        $this->dispatch('edit-grand-type', $id);
        // return redirect()->route('admin.grant_types.edit',['id'=>$id]);
    }
    public function delete($id)
    {
        ...
        $service->delete(GrantType::findOrFail($id));
        $this->successFlash(__('grantmanagement::grantmanagement.grant_type_deleted_successfully'));
    }
    ...
    public function exportSelected()
    {
        ...
        $this->clearSelected();
        return Excel::download(new GrantManagementExport($records), 'grant-types.xlsx');
    }
}
