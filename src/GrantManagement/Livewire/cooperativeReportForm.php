...
use Src\GrantManagement\Exports\CooperativeExports;
...
class cooperativeReportForm extends Component
{
    ...
    public function downloadPdf()
    {
        ...
        $html = view('GrantManagement::pdf.cooperative', compact('nepaliDate', 'palika_name', 'palika_logo', 'palika_campaign_logo', 'address', 'palika_ward', 'reports', 'startDate', 'endDate'))->render();
    ...
    public function export()
    {
        ...
        $exportFilePath = 'cooperative-report.xlsx';
        return Excel::download(new CooperativeExports($this->filtered_datas), $exportFilePath);
    }

    public function render()
    {
        return view("GrantManagement::livewire.cooperative-report-form");
    }
}
