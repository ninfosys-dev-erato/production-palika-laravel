...
use Src\GrantManagement\Exports\EnterpriseExports;
...
class EnterpriseReportForm extends Component
{
    ...
    public function downloadPdf()
    {
        ...
        $html = view('GrantManagement::pdf.enterprise', compact('nepaliDate', 'palika_name', 'palika_logo', 'palika_campaign_logo', 'address', 'palika_ward', 'reports', 'startDate', 'endDate'))->render();
    ...
    public function export()
    {
        ...
        $exportFilePath = 'enterprise-report.xlsx';
        return Excel::download(new EnterpriseExports($this->filtered_datas), $exportFilePath);
    }

    public function render()
    {
        return view("GrantManagement::livewire.enterprise-report-form");
    }
}
