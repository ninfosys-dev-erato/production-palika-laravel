...
@perm('gms_settings access')
    <li
        ...
        <ul class="menu-sub">
            ...
            <li
                class="menu-item {{ \Illuminate\Support\Facades\Route::is('admin.helplessness_types.*') ? 'active' : '' }}">
...
@perm('gms_report access')
    <!-- Reports -->
    <li
        class="menu-item {{ Route::is(
