<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary mb-0">{{ __('grantmanagement::grantmanagement.enterprise_report') }}</h4>
                        ...
                        <table class=" min-w-full bg-white">
                            <thead>
                                <tr class="bg-gray-100">
                                    <th class="py-2 px-4 border">निजि उधम/फर्म परिचय पत्र नं.</th>
                                    <th class="py-2 px-4 border">निजि उधम/फर्मको नाम </th>
                                    <th class="py-2 px-4 border">निजि उधम/फर्मको प्रकार </th>
                                </tr>
                            </thead>
                            <tbody>
