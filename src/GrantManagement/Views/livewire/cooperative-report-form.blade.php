<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary mb-0">{{ __('grantmanagement::grantmanagement.cooperative_reports') }}</h4>
                        ...
                        <table class=" min-w-full bg-white">
                            <thead>
                                <tr class="bg-gray-100">
                                    <th class="py-2 px-4 border">सहकारी परिचय पत्र नं.</th>
                                    <th class="py-2 px-4 border">दर्ता.नं.</th>
                                    <th class="py-2 px-4 border">सहकारीको नाम </th>
                                    <th class="py-2 px-4 border">सहकारीको प्रकार </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($filtered_datas as $data)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border">{{ $data->cooperative_type->title }}</td>
                                    </tr>
                                @endforeach
        ...
        <script>
            ...
            document.addEventListener('livewire:initialized', () => {
                Livewire.on('clear-select2', () => {
                    ...
                    $('#cooperative_id').val(null).trigger('change');
                    $('#enterprise_id').val(null).trigger('change');
