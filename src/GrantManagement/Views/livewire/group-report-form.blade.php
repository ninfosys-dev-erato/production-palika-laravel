<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-primary mb-0">{{ __('grantmanagement::grantmanagement.group_reports') }}</h4>
            ...
            <div class="card-body">
                ...
                <div class="mt-1 row g-3 align-items-center">
                    ...
                    <div class="col-md col-12">
                        ...
                        <div class="input-group" wire:ignore>
                            <select id="district_id" class="form-select" multiple>
                    ...
                    <div class="col-md col-12">
                        <label for="involved_cooperative_id"
                            class="form-label">{{ __('grantmanagement::grantmanagement.farmer') }}</label>
                        <div class="input-group" wire:ignore>
                            <select id="involved_framer" class="form-select" multiple>
                                @foreach ($involvedFarmer as $id => $name)
                        ...
                        <table class=" min-w-full bg-white">
                            <thead>
                                <tr class="bg-gray-100">
                                    <th class="py-2 px-4 border">समूह परिचय पत्र नं. </th>
                                    <th class="py-2 px-4 border">समूहको नाम </th>
                                    <th class="py-2 px-4 border">ठेगाना</th>
                                    <th class="py-2 px-4 border">दर्ता मिति</th>
                                    <th class="py-2 px-4 border">दर्ता भएको कार्यलय</th>
                                    <th class="py-2 px-4 border">पाना/भ्याट</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($filtered_datas as $data)
                                        <tr class="hover:bg-gray-50">
                                            <td class="py-2 px-4 border">{{ $data->unique_id}}</td>
                                            ...
                                            <td class="py-2 px-4 border">{{ $data->registration_date }}</td>
                                            <td class="py-2 px-4 border">{{ $data->registered_office}}</td>
                                            <td class="py-2 px-4 border">{{ $data->vat_pan}}</td>
                                        </tr>
                                @endforeach
    ...
    @push('scripts')
        <script>
            const selectBindings = {
                ...
                '#involved_framer': 'selected_farmer',
            };
            ...
            Livewire.on('clear-select2', () => {
                ...
                $('#involved_framer').val(null).trigger('change');
            });
            });
        </script>
    @endpush
