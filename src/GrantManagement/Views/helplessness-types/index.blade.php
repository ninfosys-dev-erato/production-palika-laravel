<x-layout.app header="{{ __('grantmanagement::grantmanagement.helplessness_type_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a
                    href="#">{{ __('grantmanagement::grantmanagement.helplessness_type') }}</a>
            </li>
                    ...
                    <div>
                        @perm('helplessness_types create')
                            ...
                            <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                                ...
                                {{ __('grantmanagement::grantmanagement.add_helplessness_type') }}
                            </button>
                        @endperm
                    </div>
                </div>
                <div class="card-body">
                    <livewire:grant_management.helplessness_type_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade " id="indexModal" tabindex="-1" aria-labelledby="AddHelplessnessTypeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddHelplessnessTypeModalLabel">
                ...
                <div class="modal-body">
                    <livewire:grant_management.helplessness_type_form :action="App\Enums\Action::CREATE" />
                </div>
            </div>
        </div>
    </div>
