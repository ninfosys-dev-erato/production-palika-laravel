<x-layout.app header="{{ __('grantmanagement::grantmanagement.cooperative_type_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a
                    href="#">{{ __('grantmanagement::grantmanagement.cooperative_type') }}</a>
            </li>
                    ...
                    <div>
                        @perm('cooperative_types create')
                            ...
                            <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                                ...
                                <i class="bx bx-plus"></i> {{ __('grantmanagement::grantmanagement.add_cooperative_type') }}
                            </button>
                        @endperm
                    </div>
                </div>
                <div class="card-body">
                    <livewire:grant_management.cooperative_type_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddCommitteeTypesModalLabel">
                        {{ __('grantmanagement::grantmanagement.cooperative_type') }}
                    </h5>
                    <button type="button" class="btn-close" onclick="resetForm()" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <livewire:grant_management.cooperative_type_form :action="App\Enums\Action::CREATE" />
