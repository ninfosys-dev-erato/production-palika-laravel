<x-layout.app header="{{ __('grantmanagement::grantmanagement.grant_office_list') }}">
    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
            <li class="breadcrumb-item"><a href="#">{{ __('grantmanagement::grantmanagement.grant_office') }}</a>
            </li>
                    ...
                    <div>
                        @perm('gms_settings create')
                            ...
                            <button class="btn btn-info" data-bs-toggle="modal" onclick="resetForm()"
                                ...
                                <i class="bx bx-plus"></i> {{ __('grantmanagement::grantmanagement.add_grant_office') }}
                            </button>
                        @endperm
                    </div>
                </div>
                <div class="card-body">
                    <livewire:grant_management.grant_office_table theme="bootstrap-4" />
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade " id="indexModal" tabindex="-1" aria-labelledby="AddGrantOfficeLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddGrantOfficeLabel">
                ...
                <div class="modal-body">
                    <livewire:grant_management.grant_office_form :action="App\Enums\Action::CREATE" />
                </div>
            </div>
        </div>
    </div>
