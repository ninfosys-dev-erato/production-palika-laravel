...
class TaskForm extends Component
{
    ...
    public function render(){
        return view("TaskTracking::livewire.task.form");
    }
    ...
    public function loadAssigne()
    {
        ...
        $this->dispatch('assignee_type-change', ['users' => $this->users]);
    ...
    public function loadReporter()
    {
        if ($this->task->reporter_type === User::class) {
            ...
            $this->reporters = $this->reporters->map(function($user) {
                return [
                    'id' => $user->id,
                    'text' => $user->name,
                ];
        ...
        $this->dispatch('reporter_type-change', ['users' => $this->users]);
