<form wire:submit.prevent="save">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    <label class="form-label" for="project_id">{{ __('tasktracking::tasktracking.choose_project') }}</label>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    <label class="form-label" for="task_type_id">{{ __('tasktracking::tasktracking.choose_task_type') }}</label>
            ...
            <div class='col-md-12'>
                <div class='form-group'>
                    <x-form.ck-editor-input label="{{ __('tasktracking::tasktracking.task_description') }}" id="task_description"
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    <label class="form-label" for="assignee_type">{{ __('tasktracking::tasktracking.assignee_type') }}</label>
                    <select wire:model="task.assignee_type" name="assignee_type" id="assignee_type"
                        ...
                        <option value="">-- {{ __('tasktracking::tasktracking.select_assignee_type') }} --</option>
            ...
            <div class="col-md-6 mb-3 ">
                <div class="form-group" wire:ignore>
                    ...
                    <select id="assignee_id" wire:model="task.assignee_id" name="task.assignee_id" class="form-control">
                        <option disabled>-- {{ __('tasktracking::tasktracking.select_assignee') }} --</option>
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group'>
                    <label class="form-label" for='reporter_type'>{{ __('tasktracking::tasktracking.reporter_type') }}</label>
                    <select wire:model='task.reporter_type' name='reporter_type' type='text'
                        ...
                        <option value="">-- {{ __('tasktracking::tasktracking.select_reporter_type') }} --</option>
            ...
            <div class='col-md-6 mb-3'>
                <div class='form-group' wire:ignore>
                    <label class="form-label" for='reporter_id'>{{ __('tasktracking::tasktracking.reporter') }}</label>
                    <select id="reporter_id" wire:model='task.reporter_id' name='task.reporter_id' type='text'
                        class='form-control' placeholder='Enter Reporter Id'>
                        {{ empty($reporters) ? 'disabled' : '' }}>
                        <option value="">-- {{ __('tasktracking::tasktracking.select_reporter') }} --</option>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="task.start_date" id="start_date"
                    ...
                    wire:model="task.start_date" placeholder="{{ __('tasktracking::tasktracking.select_start_date') }}" />
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="task.end_date" id="end_date"
                    ...
                    wire:model="task.end_date" placeholder="{{ __('tasktracking::tasktracking.select_end_date') }}" />
        ...
        <div class="mb-3">
            <div class="form-group">
                <label class="form-label" for="files">{{ __('tasktracking::tasktracking.upload_attachments') }}</label>
...
@script
    <script>
        $(document).ready(function() {
            ...
            const reporterSelect = $('#reporter_id')

            assigneeSelect.select2({

            })

            reporterSelect.select2({
            ...
            reporterSelect.on('change', function() {
