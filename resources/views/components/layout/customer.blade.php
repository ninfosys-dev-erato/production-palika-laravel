...
<head>
    <meta charset="utf-8" />
    <title>Register | Digital Epalika</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta content="B-Palika System" name="description" />
    <meta content="Coderthemes" name="author" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="https://demoerp.palikaerp.com/images/np.png" />

    <!-- Bootstrap css -->
    <link href="https://demoerp.palikaerp.com/assets/backend/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- App css -->
    <link href="https://demoerp.palikaerp.com/assets/backend/css/app.min.css" rel="stylesheet" type="text/css"
        id="app-style" />
    <!-- icons -->
    <link href="https://demoerp.palikaerp.com/assets/backend/css/icons.min.css" rel="stylesheet" type="text/css" />
