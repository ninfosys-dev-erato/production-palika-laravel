<?php $__env->startSection('hero'); ?>
    ...
    <div class="hero d-flex flex-column align-items-center justify-content-center">
        <h1 class="hero-heading">डिजिटल <?php echo e(getSetting('palika-name')); ?></h1>
        ...
        <div class="buttons">
            <button class="btn btn-primary">
                <a href="<?php echo e(route('digital-service')); ?>" class="text-white text-decoration-none"><?php echo e(__('Public Login')); ?></a>
            </button>
            <button class="btn btn-success">
                <a href="<?php echo e(route('login')); ?>" class="text-white text-decoration-none"><?php echo e(__('Office Login')); ?></a>
            </button>
            <?php if(isModuleEnabled('ebps')): ?>
                <button class="btn btn-info">
                    <a href="<?php echo e(route('organization-login')); ?>"
                        class="text-white text-decoration-none"><?php echo e(__('EBPS-लगइन')); ?></a>
                </button>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->startSection('content'); ?>
    <main>
        ...
        <?php if (isset($component)) { $__componentOriginalaf50bbf293895de913c9fb0ebdbfd47e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaf50bbf293895de913c9fb0ebdbfd47e = $attributes; } ?>
<?php $component = App\View\Components\EmployeeSectionComponent::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('employee-section-component'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\EmployeeSectionComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalaf50bbf293895de913c9fb0ebdbfd47e)): ?>
<?php $attributes = $__attributesOriginalaf50bbf293895de913c9fb0ebdbfd47e; ?>
<?php unset($__attributesOriginalaf50bbf293895de913c9fb0ebdbfd47e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaf50bbf293895de913c9fb0ebdbfd47e)): ?>
<?php $component = $__componentOriginalaf50bbf293895de913c9fb0ebdbfd47e; ?>
<?php unset($__componentOriginalaf50bbf293895de913c9fb0ebdbfd47e); ?>
<?php endif; ?>

        <!-- complaint-statistics-section -->
        <?php if(isModuleEnabled('grievance')): ?>
                ...
                <div class="statistics-wrapper">
                    <div class="statistics-card">
                        <div class="card-icon primary">
                            <div class="circle">
                                <span class="card-number" data-target="<?php echo e($grievanceCount); ?>">0</span>
                            </div>
                        </div>
                    ...
                    <div class="statistics-card">
                        <div class="card-icon success">
                            <div class="circle">
                                <span class="card-number" data-target="<?php echo e($grievancesClosedCount); ?>">0</span>
                            </div>
                        </div>
                        <div class="statistics-info">
                    ...
                    <div class="statistics-card">
                        <div class="card-icon pending">
                            <div class="circle">
                                <span class="card-number" data-target="<?php echo e($grievancesInvestigatingCount); ?>">0</span>
                            </div>
                        </div>
                        <div class="statistics-info">
        ...
        <section class="modules">
            <h2 class="module-title">डिजिटल <?php echo e(getSetting('palika-name')); ?> मोड्युल</h2>
            <div class="module-description">डिजिटल <?php echo e(getSetting('palika-name')); ?> प्रणालीमा प्रयोग भएका
            ...
            <div class="module-grid">
                <?php $__currentLoopData = $landingModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isModuleEnabled($module['module'])): ?>
                        <div class="module-card">
                            <a href="<?php echo e($module['url']); ?>" target="_blank">
                                <img src="<?php echo e(asset($module['icon'])); ?>" alt="<?php echo e($module['text']); ?> Icon" />
                                <div class="module-text"><?php echo e($module['text']); ?></div>
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="module-card">
                    <a href="https://sutrarevenue.fcgo.gov.np/web/#/login" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Training Icon" />
                ...
                <div class="module-card">
                    <a href="https://newpams.fcgo.gov.np/#/Login" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="PAMS Icon" />
                ...
                <div class="module-card">
                    <a href="https://sutra.fcgo.gov.np/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="SuTRA Icon" />
                ...
                <div class="module-card">
                    <a href="https://public.donidcr.gov.np/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Digitalcart Icon" />
                ...
                <div class="module-card">
                    <a href="https://enrollment.donidcr.gov.np/PreEnrollment/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="ID Card Icon" />
                ...
                <div class="module-card">
                    <a href="https://attendance.gov.np/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Attendance Icon" />
                ...
                <div class="module-card">
                    <a href="https://bolpatra.gov.np/egp/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Profile Icon" />
                ...
                <div class="module-card">
                    <a href="https://lisa.mofaga.gov.np/home" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Planmanagement Icon" />
                ...
                <div class="module-card">
                    <a href="https://fra.mofaga.gov.np/" target="_blank">
                        <img src="<?php echo e(asset('home/icons/sarkar.png')); ?>" alt="Financial Risk Icon" />
        ...
        <section class="features">
            <h2>विशेषताहरू</h2>
            <p class="feature-description">डिजिटल <?php echo e(getSetting('palika-name')); ?> प्रणालीमा प्रयोग भएका
        ...
        <div class="modal fade modal-services" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body"><?php echo $services; ?></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="list-unstyled">
                            <li><strong>सम्पर्क नं:</strong> <a href="tel:<?php echo e(getSetting('office_phone')); ?>"
                                    class="extra-info__contact-link"><?php echo e(getSetting('office_phone')); ?></a></li>
                            <li><strong>ईमेल:</strong> <a href="mailto:<?php echo e(getSetting('office_email')); ?>"
                                    class="extra-info__contact-link"><?php echo e(getSetting('office_email')); ?></a></li>
                        </ul>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<?php echo $__env->make('home.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/frontend/CustomerPortal/Home/Views/home.blade.php ENDPATH**/ ?>